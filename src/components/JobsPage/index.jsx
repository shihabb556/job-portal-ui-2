...
const JobsPage = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className="relative p-4 mx-auto max-w-screen-lg mt-[4em]">
                {/* Fixed Search and Filter Section */}
                <div className="fixed top-16 left-0 right-0 bg-white shadow-md z-10 p-4">
                ...
                <div className="pt-[16em]"> {/* Adjust padding-top based on the height of the fixed section */}
                    {/* Job Cards */}
